...
(:: pragma bea:global-element-return element="ns2:parametrosVerificaWhiteList" location="../../../../../EBS/Credito/xsd/ParametrosCredito.xsd" ::)
...
declare namespace xf = "http://tempuri.org/OSB_Pedro/ServicosNegocio/Credito/Resources/Transformations/CreditoGeral/ParametrosScoreClienteToVerficiaWhiteList/";

declare function xf:ParametrosScoreClienteToVerficiaWhiteList($parametrosScoreCliente1 as element(ns1:parametrosScoreCliente))
...
xf:ParametrosScoreClienteToVerficiaWhiteList($parametrosScoreCliente1)
